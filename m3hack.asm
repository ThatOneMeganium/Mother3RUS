...
org $8040456; db $C2         // Goods
org $8040902; db $C2
org $8040A82; db $B5         // Equip
org $804121E; db $B5
org $8043016; db $B5
org $8040C26; db $C3         // PSI
org $80410AE; db $BE         // Status
org $804167E; db $A0         // Battle Memory
org $8041886; db $BA         // Shop
org $8041990; db $BA
org $8041D00; db $BA
org $804181A; db $BA
org $8041F36; db $B5         // Item Dude
org $80420AC; db $B5
org $8042348; db $B5
org $8041FA2; db $B5
...
org $813C700
hardmodestring:
dw $0078,$0062,$0073,$0066,$0040,$006F,$0071,$0066,$0001,$FFFF
